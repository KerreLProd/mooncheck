const buttons = [
    ...
    {short: 'tg_group', text: 'ГРУППА В TG', url: 'https://t.me/+JSv387j2viZkMjZi'},
    {short: 'bh', text: 'ПРОФИЛЬ НА BLASTHACK', url: 'https://www.blast.hk/members/432349/'},
    {short: 'mlog', text: 'ЧЕКЕР ОШИБОК MOONLOADER', url: 'https://kerrelprod.github.io/mooncheck/mooncheck.html'},
]
